...
export default function Avatar({userId,email,online, avatar}) {
    ...
    return (
        <div className={'w-12 h-12 relative rounded-full flex items-center '}>
            {avatar ? (
                <img src={avatar} alt="" className="text-center w-full h-full object-cover rounded-full"/>
            ): (
